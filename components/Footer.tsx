        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/about" className="text-blue-200 hover:text-white transition-colors flex items-center group">
                  <FaChevronRight
                    className={`h-4 w-4 mr-1 opacity-70 group-hover:translate-x-1 transition-transform duration-300 ${isRtl ? "rotate-180" : ""}`}
                  />
                  {t('footer_about')}
              ...
              <li>
                <a href="https://wa.me/message/TGUCWCSB54XKM1" className="text-blue-200 hover:text-white transition-colors flex items-center group">
                  <FaChevronRight
                    className={`h-4 w-4 mr-1 opacity-70 group-hover:translate-x-1 transition-transform duration-300 ${isRtl ? "rotate-180" : ""}`}
                  />
                  {t('footer_contactUs')}
