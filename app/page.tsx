...
const UserTypeSection = ({ language,t, isRtl } : { language : Language, t: TranslationFn , isRtl: boolean}) => {
  ...
  [key: string]: {
    ...
    ar: {
      // Premium Buyer benefits
      "استيراد السيارات بسهولة ومرونة":
      ...
      "بطاقة رمادية فورًا أو بتكلفة أقل لاحقًا":
            ...
            >
              ...
              <div className={`p-8 ${type.featured ? "text-white" : "text-gray-800"}`}>
                <div
                  ...
                  } flex items-center justify-center mb-6 shadow-md group-hover:scale-110 transition-transform duration-300`}
                >
                  {type.icon}
                </div>
